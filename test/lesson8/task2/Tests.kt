...
class Tests {
    ...
    fun kingTrajectory() {
        ...
        assertEquals(listOf(square("b2"), square("b1")), kingTrajectory(square("b2"), square("b1")))
        kingTrajectory(square("b2"), square("b1")).assertKingTrajectory(square("b2"), square("b1"), 1)
    }
