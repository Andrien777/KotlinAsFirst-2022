...
fun decimal(digits: List<Int>, base: Int): Int {
    ...
    for (i in newDigits.indices)
        answer += newDigits[i] * base.toDouble().pow(i).toInt()
    return answer
}
...
fun russian(n: Int): String {
    ...
    answer = answer.filter { it != "" }.toMutableList()
